...
public class ContactListController {
    ...
    public boolean addContact(Contact contact, Context context){
        ...
        return add_contact_command.getIsExecuted();
    }
    ...
    public boolean deleteContact(Contact contact, Context context) {
        ...
        return delete_contact_command.getIsExecuted();
    }
    ...
    public boolean editContact(Contact contact, Contact updated_contact, Context context){
        ...
        return edit_contact_command.getIsExecuted();
    }
    ...
    public Contact getContactByUsername(String username) { return contact_list.getContactByUsername(username); }

    public boolean isUsernameAvailable(String username) { return contact_list.isUsernameAvailable(username); }
